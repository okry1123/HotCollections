 ...
 */
public class TypeRankingListFragment extends android.support.v4.app.ListFragment {

    private int type;

    public static TypeRankingListFragment launch(int type){
        TypeRankingListFragment fragment = new TypeRankingListFragment();
        Bundle b = new Bundle();
        b.putInt("type", type);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        HttpManager.getInstance().doGetTypeList(GameData.SHOW_TYPE_PH_INNER, String.valueOf(type), 0, ConstValue.PAGE_SIZE, new Response.Listener<GameListResponse>() {
            @Override
