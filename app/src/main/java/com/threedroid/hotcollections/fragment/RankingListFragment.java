 ...
 */
public class RankingListFragment extends android.support.v4.app.ListFragment {

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);

        HttpManager.getInstance().doGetHomeList(GameData.SHOW_TYPE_PH_HOME, 0, ConstValue.PAGE_SIZE, new Response.Listener<GameListResponse>() {
            @Override
